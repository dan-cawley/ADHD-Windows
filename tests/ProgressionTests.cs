...
namespace AdhdWarrior {
 public static class ProgressionTests {
  ...
  public static int Run(){
   ...
   Check(migrated.Version==13&&migrated.Quests[0].Rarity=="Common"&&migrated.Quests[0].XP==135&&migrated.XP==1200&&migrated.Coins==99,"Older saves preserve balances and custom quest rewards");
