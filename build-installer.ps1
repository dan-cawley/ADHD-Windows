...
try {
 ...
 & $compiler /nologo /target:winexe /platform:anycpu /optimize+ "/win32icon:$PSScriptRoot\assets\adhd-warrior.ico" "/win32manifest:$PSScriptRoot\installer\installer.manifest" "/out:$setup" "/resource:$payload,payload.zip" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll (Join-Path $PSScriptRoot 'installer\Installer.cs')
