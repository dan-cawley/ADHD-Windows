...
$output = Join-Path $PSScriptRoot 'dist\0.19.1'
...
& $compiler /nologo /target:winexe /platform:anycpu /optimize+ "/out:$output\ADHD Warrior.exe" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Web.Extensions.dll /reference:System.Security.dll $sources
