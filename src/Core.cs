...
namespace AdhdWarrior {
 ...
 public class SaveData {
  ...
  public SaveData() {Version=9; Quests=new List<Quest>();StreakQuests=new List<StreakQuest>();Reminders=new ReminderSettings();Journey=new JourneyState();DailyTemplates=DailyTemplatesEngine.Defaults();AutoGenerateDaily=true;PendingRewards=new List<PendingReward>();ClaimedMilestones=new List<int>();}
 }
 ...
 public static class Storage {
  ...
  public static SaveData Decode(string json) {
   ...
   if(data==null || data.Version<1||data.Version>9 || data.Quests==null || data.XP<0 || data.Coins<0 || data.Quests.Count>100000) throw new InvalidDataException("This is not a supported Windows backup.");
