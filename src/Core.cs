...
namespace AdhdWarrior {
 ...
 public static class Storage {
  ...
  public static SaveData Decode(string json) {
   ...
   if(data==null || data.Version<1||data.Version>10 || data.Quests==null || data.XP<0 || data.Coins<0 || data.Quests.Count>100000) throw new InvalidDataException("This is not a supported Windows backup.");
