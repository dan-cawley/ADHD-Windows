...
namespace AdhdWarrior {
 static class Program {
  ...
  static bool RestoreExisting(){var window=FindWindow(null,"ADHD Warrior — Windows 0.22.3");if(window==IntPtr.Zero)return false;ShowWindow(window,9);SetForegroundWindow(window);return true;}
