...
namespace AdhdWarrior {
 static class Program {
  ...
  static bool RestoreExisting(){var window=FindWindow(null,"ADHD Warrior — Windows 0.20.1");if(window==IntPtr.Zero)return false;ShowWindow(window,9);SetForegroundWindow(window);return true;}
